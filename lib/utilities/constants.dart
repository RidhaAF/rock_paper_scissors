...
Color lightColor = Colors.pink.shade300;
...
// 32
TextStyle largeTitle = GoogleFonts.barlow(
  fontSize: largeTitleFS,
);

// 28
TextStyle title1 = GoogleFonts.barlow(
  fontSize: title1FS,
);

// 24
TextStyle title2 = GoogleFonts.barlow(
  fontSize: title2FS,
);

// 20
TextStyle title3 = GoogleFonts.barlow(
  fontSize: title3FS,
);

// 18
TextStyle headline = GoogleFonts.barlow(
  color: whiteColor,
  fontSize: headlineFS,
  fontWeight: semiBold,
);
...
// 16
TextStyle callout = GoogleFonts.barlow(
  fontSize: calloutFS,
);

// 14
TextStyle subheadline = GoogleFonts.barlow(
  fontSize: subheadlineFS,
);

// 13
TextStyle footnote = GoogleFonts.barlow(
  fontSize: footnoteFS,
);

// 12
TextStyle caption1 = GoogleFonts.barlow(
  fontSize: caption1FS,
);

// 10
TextStyle caption2 = GoogleFonts.barlow(
  fontSize: caption2FS,
);

// text style per color
TextStyle primaryTextStyle = GoogleFonts.barlow(
  color: primaryColor,
);

TextStyle secondaryTextStyle = GoogleFonts.barlow(
  color: secondaryColor,
);

TextStyle mutedTextStyle = GoogleFonts.barlow(
  color: mutedColor,
);
...
TextStyle darkGreyTextStyle = GoogleFonts.barlow(
  color: darkGreyColor,
);
